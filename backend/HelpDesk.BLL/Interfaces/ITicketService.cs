...
namespace HelpDesk.BLL.Interfaces
{
    public interface ITicketService
    {
        ...
        Task<UpdateTicketResult> UpdateAsync(int ticketId, UpdateTicketRequestDto request, int requestingUserId);
        ...
        Task<DeleteTicketResult> DeleteAsync(int ticketId, int requestingUserId);
